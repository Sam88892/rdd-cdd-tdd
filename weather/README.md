# cli-weather
 ...
                                  First step: You run the console and you go into the correct directory with the cd command
                                  Second step: You install the modules using the command "npm install -a"
                                  Third step:Type the command "node cli.js city country"
                                  Fourth step: The weather is displayed in the console
